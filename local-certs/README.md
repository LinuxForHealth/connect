...
pyConnect uses base-64 encoded "PEM" formatted keys and certificates. Each secured external connection is configured to use a custom SSL context which explicitly defines the keys and certificates used.
